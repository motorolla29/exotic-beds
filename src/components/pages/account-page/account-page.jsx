...
import AccountPagePersonalData from '../../account-page-personal-data/account-page-personal-data';
import AccountPageContactDetails from '../../account-page-contact-details/account-page-contact-details';
  ...
  return (
    <div className="account-page">
      ...
      <div className="account-page_user-info">
        <AccountPagePersonalData />
        <AccountPageContactDetails />
      </div>
